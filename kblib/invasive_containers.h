...
template <typename Value, auto Key, typename Hash = kblib::FNV_hash<member_t<Value, Key>>>
class invasive_map {
 public:
...
template <typename Value, auto Key1, auto Key2, typename Hash1 = kblib::FNV_hash<member_t<Value, Key1>>, typename Hash2 = kblib::FNV_hash<member_t<Value, Key2>>>
